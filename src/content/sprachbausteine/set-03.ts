...
Mahdin Islam`,
    ...
    items: [
      ...
      {
        nr: 10,
        options: ["entschuldigen", "entschuldige", "entschuldigt"],
        answerIndex: 1,
...
Ihre Gesundheitskasse Siegen`,
    ...
    bank: [
      { key: "a", word: "bezahlen" },
      { key: "b", word: "sitzen" },
      { key: "c", word: "erreichen" },
      { key: "d", word: "Fragen" },
      { key: "e", word: "Anmeldung" },
      { key: "f", word: "gesund" },
      { key: "g", word: "Termine" },
      { key: "h", word: "denken" },
      { key: "i", word: "Kosten" },
      { key: "j", word: "Krankheiten" },
      { key: "k", word: "Voraussetzungen" },
      { key: "l", word: "wohnen" },
    ...
    items: [
      {
        ...
        why: {
          de: "»die drei wichtigsten Voraussetzungen für ein gesundes Leben« — eine Voraussetzung ist das, was nötig ist, damit etwas gelingt. »Krankheiten« (j) passt zum Thema, aber nicht zum Sinn: Krankheiten sind keine Bedingung für ein gesundes Leben.",
          en: "'the three most important prerequisites for a healthy life' — a Voraussetzung is what must be in place for something to work. 'Krankheiten' (j) fits the topic but not the sense: illnesses are not a condition for a healthy life.",
          it: "»i tre presupposti più importanti per una vita sana«. »Krankheiten« (j) è in tema ma non ha senso qui.",
          bn: "»সুস্থ জীবনের তিনটি প্রধান পূর্বশর্ত« — Voraussetzung মানে যা থাকা দরকার। »Krankheiten« (j) বিষয়ের সঙ্গে মেলে, অর্থের সঙ্গে নয়।",
        },
      },
      {
        nr: 12,
        ...
        tag: "wortschatz-verb",
        why: {
          de: "»die im Büro arbeiten und viel sitzen« — das ist der Grund für einen Rückenkurs. Der Satzbau verlangt hier ein Verb im Plural (»die … arbeiten und …«), also »sitzen«, nicht »wohnen« (l), das inhaltlich nichts mit dem Rücken zu tun hat.",
          en: "'who work in an office and sit a lot' — that is why a back course exists. The structure needs a plural verb ('die … arbeiten und …'), so 'sitzen', not 'wohnen' (l), which has nothing to do with backs.",
      ...
      },
      {
        ...
        tag: "wortschatz-nomen",
        why: {
          de: "»Die Anmeldung ist online oder telefonisch möglich.« Das Artikelwort »Die« und das Verb »ist« zeigen: hier steht ein Nomen im Singular. »Termine« (g) wäre Plural und würde »sind« verlangen.",
          en: "'Die Anmeldung ist online oder telefonisch möglich.' The article 'Die' and the verb 'ist' show a singular noun is needed. 'Termine' (g) is plural and would require 'sind'.",
          it: "»Die Anmeldung ist …« — l'articolo e »ist« indicano un singolare. »Termine« (g) richiederebbe »sind«.",
          bn: "»Die Anmeldung ist …« — »Die« ও »ist« দেখায় এখানে একবচন বিশেষ্য লাগবে। »Termine« (g) বহুবচন, »sind« চাইত।",
        },
      },
      {
        nr: 14,
        ...
        tag: "wortschatz-nomen",
        why: {
          de: "»Die Kosten für unsere Kurse übernehmen wir zu achtzig Prozent.« Kosten übernehmen ist die feste Wendung; »bezahlen« (a) ist ein Verb und würde hier nicht hinter »Die« stehen können.",
          en: "'Die Kosten für unsere Kurse übernehmen wir …' — Kosten übernehmen is the set phrase; 'bezahlen' (a) is a verb and could not follow 'Die'.",
          it: "»Die Kosten … übernehmen wir« è l'espressione fissa; »bezahlen« (a) è un verbo.",
          bn: "»Die Kosten … übernehmen wir« — নির্দিষ্ট বাগধারা; »bezahlen« (a) ক্রিয়া, »Die«-এর পরে বসতে পারত না।",
        },
      },
      {
        nr: 15,
      ...
      },
      {
        ...
        why: {
          de: "»Diese sind für alle Versicherten kostenlos.« Nach »sind« steht ein Adjektiv ohne Endung. »gesund« (f) wäre grammatisch möglich, ergibt aber keinen Sinn: Videos sind nicht gesund, sie sind gratis.",
          en: "'Diese sind für alle Versicherten kostenlos.' After 'sind' comes an uninflected adjective. 'gesund' (f) would be grammatically possible but makes no sense: videos are not healthy, they are free.",
          it: "Dopo »sind« serve un aggettivo. »gesund« (f) sarebbe grammaticale ma senza senso.",
          bn: "»Diese sind … kostenlos।« »sind«-এর পরে প্রত্যয়হীন বিশেষণ। »gesund« (f) ব্যাকরণে চলত, অর্থে নয়।",
        },
      },
      {
        nr: 18,
